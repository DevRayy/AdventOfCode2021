...
fn part1(input: &str) -> i64 {
    ...
    let desired_state = State {
        hall: ['.', '.', '.', '.', '.', '.', '.', '.', '.', '.', '.'],
        rooms: [vec!['A', 'A'], vec!['B', 'B'], vec!['C', 'C'], vec!['D', 'D']],
    };
...
fn load(input: &str) -> State {
    ...
    let room1: Vec<char> = vec![lines[3].chars().nth(3).unwrap(), lines[2].chars().nth(3).unwrap()];
    let room2: Vec<char> = vec![lines[3].chars().nth(5).unwrap(), lines[2].chars().nth(5).unwrap()];
    let room3: Vec<char> = vec![lines[3].chars().nth(7).unwrap(), lines[2].chars().nth(7).unwrap()];
    let room4: Vec<char> = vec![lines[3].chars().nth(9).unwrap(), lines[2].chars().nth(9).unwrap()];
    State {
        hall: ['.', '.', '.', '.', '.', '.', '.', '.', '.', '.', '.'],
